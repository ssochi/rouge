...
export const FLOOR_CONFIGS = {
    1: {
        ...
        eliteAffixCount: [1, 1],
        depthTiers: {
            shallow: { countMin: 4, countMax: 5, weights: { wraith: 4, zombie: 2, archer: 3, zombie_female: 2, plague_rat: 2, hellhound: 1.5 } },
            mid: { countMin: 5, countMax: 7, weights: { wraith: 3, archer: 3, zombie_female: 2, boomer: 2, zombie_brute: 1.5, lobber: 1, gargoyle: 1.5, cultist: 1.5 } },
            deep: { countMin: 6, countMax: 8, weights: { wraith: 2, archer: 2.5, zombie_brute: 2, warlock: 1.5, boomer: 1.5, shieldbearer: 1.5, sentry: 1, lobber: 1, spinner: 1 } }
        },
        ...
        roleMap: {
            m: ['wraith', 'wraith', 'zombie', 'zombie_female', 'hellhound', 'plague_rat'],
    ...
    2: {
        ...
        depthTiers: {
            shallow: { countMin: 6, countMax: 7, weights: { zombie_female: 3, zombie_brute: 3, hunter: 1.5, boomer: 2 } },
            mid: { countMin: 7, countMax: 9, weights: { zombie_brute: 1.5, hunter: 1.25, soldier: 1.25, warlock: 2, boomer: 1.5, shieldbearer: 2, summoner: 1, lobber: 1.5, sentry: 1, flail_warden: 1.5, gargoyle: 1.5, cultist: 2, spinner: 2, weeper: 1.5, splitter: 1.5 } },
            deep: { countMin: 8, countMax: 10, weights: { hunter: 1, soldier: 1.75, warlock: 2.5, shieldbearer: 2, summoner: 1.5, lobber: 1.5, sentry: 1.5, flail_warden: 1.5, gargoyle: 1.5, cultist: 2, spinner: 2, weeper: 2, splitter: 1.5 } }
        },
        // 精英房编成保持不变（精英场合枪兵合理）
        ...
        roleMap: {
            m: ['zombie_female', 'boomer', 'wraith', 'hellhound'],
    ...
    3: {
        ...
        depthTiers: {
            shallow: { countMin: 7, countMax: 8, weights: { zombie_brute: 3, hunter: 2.5, soldier: 1.5, boomer: 2.5, spinner: 2, weeper: 1.5, splitter: 1.5 } },
            mid: { countMin: 8, countMax: 10, weights: { zombie_brute: 1.5, hunter: 2, soldier: 1.25, warlock: 2.5, boomer: 2, shieldbearer: 2, summoner: 1.5, lobber: 2, sentry: 1.5, flail_warden: 2, gargoyle: 2, spinner: 2, weeper: 2, splitter: 1.5 } },
            deep: { countMin: 9, countMax: 11, weights: { hunter: 2, soldier: 1.5, warlock: 3, shieldbearer: 2.5, summoner: 2, lobber: 2, sentry: 2, flail_warden: 2, gargoyle: 2, spinner: 2, weeper: 2, splitter: 2 } }
        },
        // 精英房编成保持不变
        ...
        roleMap: {
            m: ['boomer', 'zombie_brute', 'hellhound'],
