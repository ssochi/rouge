...
export const FLOOR_CONFIGS = {
    1: {
        ...
        depthTiers: {
            ...
            deep: { countMin: 6, countMax: 8, weights: { zombie_brute: 2, hunter: 3, soldier: 3, warlock: 1.5, boomer: 1, shieldbearer: 1.5 } }
        },
    ...
    2: {
        ...
        depthTiers: {
            ...
            mid: { countMin: 7, countMax: 9, weights: { zombie_brute: 1.5, hunter: 3, soldier: 3, warlock: 2, boomer: 1.5, shieldbearer: 2, summoner: 1 } },
            deep: { countMin: 8, countMax: 10, weights: { hunter: 2.5, soldier: 4, warlock: 2.5, shieldbearer: 2, summoner: 1.5 } }
        },
    ...
    3: {
        ...
        depthTiers: {
            ...
            mid: { countMin: 8, countMax: 10, weights: { zombie_brute: 1.5, hunter: 2.5, soldier: 3, warlock: 2.5, boomer: 2, shieldbearer: 2, summoner: 1.5 } },
            deep: { countMin: 9, countMax: 11, weights: { hunter: 2.5, soldier: 4, warlock: 3, shieldbearer: 2.5, summoner: 2 } }
        },
