...
export const FLOOR_CONFIGS = {
    1: {
        ...
        roleMap: {
            ...
            r: ['archer', 'archer', 'hunter', 'cultist'],
    ...
    2: {
        ...
        depthTiers: {
            ...
            mid: { countMin: 7, countMax: 9, weights: { zombie_brute: 1.5, hunter: 2.5, soldier: 2.5, warlock: 2, boomer: 1.5, shieldbearer: 2, summoner: 1, lobber: 1.5, sentry: 1, flail_warden: 1.5, gargoyle: 1.5, cultist: 2 } },
            deep: { countMin: 8, countMax: 10, weights: { hunter: 2, soldier: 3.5, warlock: 2.5, shieldbearer: 2, summoner: 1.5, lobber: 1.5, sentry: 1.5, flail_warden: 1.5, gargoyle: 1.5, cultist: 2 } }
        },
        ...
        roleMap: {
            ...
            r: ['hunter', 'lobber', 'warlock', 'sentry', 'archer', 'cultist'],
    ...
    3: {
        ...
        depthTiers: {
            ...
            mid: { countMin: 8, countMax: 10, weights: { zombie_brute: 1.5, hunter: 2, soldier: 2.5, warlock: 2.5, boomer: 2, shieldbearer: 2, summoner: 1.5, lobber: 2, sentry: 1.5, flail_warden: 2, gargoyle: 2 } },
            deep: { countMin: 9, countMax: 11, weights: { hunter: 2, soldier: 3, warlock: 3, shieldbearer: 2.5, summoner: 2, lobber: 2, sentry: 2, flail_warden: 2, gargoyle: 2 } }
        },
