...
export const WEAPONS = {
    ...
    rocket_launcher: {
        ...
        // Stats
        fireRate: 1500, // Slow
        damage: 85,     // Impact damage (plus AOE)
    ...
    meteor_cannon: {
        name: "陨石炮",
        type: WeaponType.RIFLE,
        sprite: "meteor_cannon",
        drawOffset: { x: -10, y: -10 },
        muzzleOffset: { x: 20, y: -3 },
        scale: 1.5,
        hands: {
            right: { x: 0, y: 3 },
            left: { x: 7, y: 3 }
